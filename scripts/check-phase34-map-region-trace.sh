...
grep -R "AgentChatFloat" -n srmp-web-ui/src/views/gis >/dev/null
...
grep -R "GENERATE_REGION_SOLUTION" -n srmp-web-ui/src srmp-ai-orchestrator/app srmp-agent/src/main/java >/dev/null
...
echo "[OK] phase34 map region and unified trace hooks are routed through LangGraph run"
